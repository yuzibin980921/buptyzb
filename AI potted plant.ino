...
#define SSID           "yzb"                   // cannot be longer than 32 characters!
#define PASSWORD       "yzb980921"
...
//WEBSITE     
#define HOST_NAME    "192.168.43.150"             //可改成自己的服务器地址和端口
...
{   
    ...
    soil_humidity=analogRead(Moisture_ain);
  if(soil_humidity>100)
  {
    Serial.println("Do not need water");
